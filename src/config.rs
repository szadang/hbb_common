...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("旅逍客远控".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["de.slwz.com"];
pub const RS_PUB_KEY: &str = "ZovQgKcBW4irBWkQ4Bm5cdC7CWDTTiTeXun9FfPtvUk=";
